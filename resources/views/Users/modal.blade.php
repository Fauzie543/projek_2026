...
<div id="userModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden flex items-center justify-center z-50">
    ...
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg">
        ...
        <div class="flex justify-between items-center border-b pb-3 mb-4">
            <h3 id="modal_title" class="text-xl font-semibold">Add New User</h3>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                     <small class="text-gray-500 block">Leave blank to keep current password.</small>
                    <div class="relative mt-1">
                        ...
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
                            <span class="toggle-password cursor-pointer text-gray-400 hover:text-gray-600">
                                ...
                                <svg class="icon-hide h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7 1.274-4.057 5.064 7 9.542-7 .847 0 1.67.127 2.455.364m-6.91 6.91a3 3 0 014.243-4.243m-4.243 4.243l4.243-4.243m-1.245 6.354A6.975 6.975 0 0112 15a6.975 6.975 0 01-2.43-13.35l-1.022-1.022m-1.022 1.022L3 3m18 18l-3-3m-3-3l-3-3"></path></svg>
                            </span>
                        </div>
                    </div>
